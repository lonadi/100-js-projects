var samples = [
    ...
    "Jumpy zebras quickly vex daft oxen by finding bright stars on the horizon, casting long shadows over the sprawling savannah as the evening breeze gently sways the tall grass.",
    "Lazy dogs often nap quietly under shady pine trees while squirrels scurry around, gathering acorns for the upcoming winter, their tiny feet making barely a sound on the forest floor.",
    "Quaint villages glow softly beneath the moon's pale light, where cobblestone streets echo the footsteps of late-night wanderers, and flickering lanterns illuminate the cozy windows of stone cottages.",
    "Bright kites fly swiftly above sunlit green fields, their tails whipping in the wind as children laugh and run, chasing the breeze, their footsteps leaving light imprints on the soft earth.",
    "Yellow birds chirp loudly as they soar through clear skies, darting between treetops, while the scent of blooming flowers fills the air, and bees busily hum from petal to petal.",
    "Oddly, purple owls silently hoot from towering oak trees, their eyes gleaming in the dim light as they watch over the quiet forest, while the stars twinkle faintly above the treetops.",
    "Frogs leap eagerly into the calm shimmering lake at dusk, sending ripples across the glassy surface as fireflies dance on the water's edge, their soft glow lighting up the night.",
    "Eleven eager explorers journeyed across the vast arctic plains, their boots crunching in the snow as they braved the icy winds, searching for hidden treasures buried beneath the frozen tundra.",
    "Quick brown foxes jump over sleepy dogs without hesitation, their sleek coats glistening in the early morning sun as they sprint through the meadow, leaving only a blur in their wake.",
    "Zany clowns danced merrily on the bright circus stage, their colorful costumes sparkling under the lights as they performed acrobatic stunts and juggled flaming torches, much to the delight of the audience."
];
var infinityPara =
